...
//    output.vColor.a = seed;
   ...
   seed = (seed -0.5)*2 ;
    ...
    seed = fmod(seed *11235.123456f + 0.1159123f, 1.0);
    output.vColorVariation.g = gColorVariation.r * seed;
    seed = fmod(seed *11235.123456f + 0.1159123f, 1.0);
    output.vColorVariation.b = gColorVariation.r * seed;
    output.vColorVariation.a = gColorVariation.r * seed;
...
float4 mainPS2(float2 uv: TEXCOORD0, float4 vColorVariation: COLOR, float2 colorIndex : TEXCOORD1) : COLOR 
{
