...
namespace Conquera
{
    public class BloodyFeastSpell : Spell
    {
        private static GraphicElement mPictureGraphicElement = GuiManager.Instance.Palette.CreateGraphicElement("SpellIconBloodyFeast");
        private static GraphicElement mIconGraphicElement = GuiManager.Instance.Palette.CreateGraphicElement("SpellIconBloodyFeast");
        ...
        {
            get { return "BloodyFeast"; }
        }

        public override string DisplayName
        {
            get { return "BloodyFeast spell"; }
        }
